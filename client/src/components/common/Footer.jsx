...
import { FooterLink2 } from './../../../constants/footer-links';
...
const Footer = () => {
    return (
        <div className="bg-[#1d1d1d] rounded-3xl mt-10">
            <div className="flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-14">
                <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">

                    {/* Section 1 */}
                    <div className="lg:w-[60%] bg-whit flex flex-wrap justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
                        <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
                            <img src={TaskifyLogo} alt="" className="object-contain" />
                    ...
                    {/* Section 2 */}
                    <div className="lg:w-[40%] flex flex-wrap justify-between pl-3 lg:pl-5 gap-3">
                        {FooterLink2.map((ele, i) => {
                            return (
                                <div key={i} className="mb-7 lg:pl-0">
                                    <h1 className="text-richblack-50 font-semibold text-[16px]">
                                        {ele.title}
                                    </h1>
                                    <div className="flex flex-col gap-2 mt-2">
