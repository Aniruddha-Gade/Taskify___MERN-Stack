...
// images
import dashboard from '../../../screenshots/dashboard 3.png'
...
import taskImg4 from '../../../screenshots/loading-skeleton.png'
import taskImg5 from '../../../screenshots/completed-task.png'
import taskImg6 from '../../../screenshots/responsive1.png'
import taskImg7 from '../../../screenshots/todo-details.png'
...
const home = () => {
  return (
    <div className='mt-[70px] p-5 sm:px-10 h-full pb-16'>
      <section className='flex flex-col sm:flex-row justify-between gap-10'>
        <div className='flex flex-col gap-5 sm:gap-10 '>
          <h1 className='capitalize text-4xl md:text-5xl lg:text-6xl 2xl:text-7xl text-green-500 font-bold '>
            organize your <br />task more easily <br />with us ❤️
          </h1>
